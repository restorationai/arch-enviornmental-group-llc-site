...
export const brand = {
  ...
  tagline: "24/7 restoration services in Kingsburg, CA.",
  ...
  homeAboutBlurb: "Arch Enviornmental Group LLC serves Kingsburg and the surrounding CA area with professional damage restoration for homes and businesses. From the first emergency call to the final walkthrough, our team manages the entire recovery — and we answer the phone 24/7, so help is on the way the moment something goes wrong.",
} as const;
